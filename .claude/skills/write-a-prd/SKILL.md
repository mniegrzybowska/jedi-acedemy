---
name: write-a-prd
description: "Create a PRD by interviewing the user about their problem and solution, exploring the codebase, and producing a structured spec with user stories and implementation decisions. Use when the user wants to create a PRD, write a spec, or plan a feature."
---
